...
const RegisterPage = ()=>{
    ...
    const login = (0, __TURBOPACK__imported__module__$5b$project$5d2f$stores$2f$authStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
        "RegisterPage.useAuthStore[login]": (state)=>state.login
    }["RegisterPage.useAuthStore[login]"]);
    ...
    const handleSubmit = async (e)=>{
        ...
        setError(null);
        try {
            const userInfo = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].register({
                name,
                email,
                password
            });
...
_s(RegisterPage, "6W1/XCxRCEhnRBvd7uziydTxR7I=", false, function() {
    return [
