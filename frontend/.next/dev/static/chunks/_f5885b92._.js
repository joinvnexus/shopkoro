            ...
            const fetchUserData = {
                "ProfilePage.useEffect.fetchUserData": async ()=>{
                    try {
                        ...
                        setUser(userData);
                        // Fetch user orders
                        const ordersData = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["orderApi"].getUserOrders();
                        setOrders(ordersData.orders || []);
                        // If orderId is provided in URL, fetch that order
                        if (orderId) {
                            setActiveTab("orders");
                            try {
                                const orderData = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["orderApi"].getOrderById(orderId);
...
//# sourceMappingURL=_f5885b92._.js.map